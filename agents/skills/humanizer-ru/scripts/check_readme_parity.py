...
Запись доказательств есть у 32 из 38 маркеров.
## Что ему давать
...
Currently 32 of 38 markers have a full record.
## What to give it
...
def selftest():
    ...
    bad = dict(base)
    bad[RU] = GOOD_RU.replace(u"32 из 38", u"38 из 38")
    bad[EN] = GOOD_EN.replace(u"32 of 38", u"38 of 38")
    ...
    bad = dict(base); bad[RU] = GOOD_RU.replace(
        u"Запись доказательств есть у 32 из 38 маркеров.\n", u"")

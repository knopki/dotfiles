...
Полная запись доказательств — неизменяемая ссылка на источник, дата обращения, дословный образец, класс доказательства и fixture — есть у 32 из 38 маркеров. Остальные закрыты только фикстурами. Валидатор печатает это число как есть, а не округляет его до удобного.

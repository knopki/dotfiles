# mise completes rclone from the packslip of whichever version is active.
# @generated by usage's installer for `mise completion fish --tool rclone --install`
...
complete -c 'rclone' -f -a '(__mise_load_rclone)'

# mise completes terraform-docs from the packslip of whichever version is active.
# @generated by usage's installer for `mise completion fish --tool terraform-docs --install`
...
function __mise_load_terraform_2ddocs
    ...
    ' -- 'terraform-docs' $__mise_line
end
complete -c 'terraform-docs' -f -a '(__mise_load_terraform_2ddocs)'

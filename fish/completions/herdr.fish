# mise completes herdr from the packslip of whichever version is active.
# @generated by usage's installer for `mise completion fish --tool herdr --install`
...
complete -c 'herdr' -f -a '(__mise_load_herdr)'

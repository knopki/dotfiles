# mise completes prek from the packslip of whichever version is active.
# @generated by usage's installer for `mise completion fish --tool prek --install`
...
complete -c 'prek' -f -a '(__mise_load_prek)'

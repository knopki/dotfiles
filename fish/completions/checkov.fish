# mise completes checkov from the packslip of whichever version is active.
# @generated by usage's installer for `mise completion fish --tool checkov --install`
...
complete -c 'checkov' -f -a '(__mise_load_checkov)'

# mise completes fnox from the packslip of whichever version is active.
# @generated by usage's installer for `mise completion fish --tool fnox --install`
...
complete -c 'fnox' -f -a '(__mise_load_fnox)'

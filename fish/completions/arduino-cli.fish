# mise completes arduino-cli from the packslip of whichever version is active.
# @generated by usage's installer for `mise completion fish --tool arduino-cli --install`
...
function __mise_load_arduino_2dcli
    ...
    ' -- 'arduino-cli' $__mise_line
end
complete -c 'arduino-cli' -f -a '(__mise_load_arduino_2dcli)'

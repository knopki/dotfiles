...
complete -c nono -n "__fish_nono_needs_command" -f -a "platform" -d 'Enroll with and inspect an audit control plane'
complete -c nono -n "__fish_nono_needs_command" -f -a "trust" -d 'Manage file trust and attestation'
complete -c nono -n "__fish_nono_needs_command" -f -a "ps" -d 'List local or remote sandboxed sessions'
...
complete -c nono -n "__fish_nono_needs_command" -f -a "connect" -d 'Connect this terminal to a session hosted by nono-console'
...
complete -c nono -n "__fish_nono_using_subcommand run" -l sandbox-policy -d 'Linux sandbox enforcement mechanism [auto|landlock|external] (default: auto)' -r -f -a "auto\t'Landlock plus a static seccomp baseline for restricted networking, with automatic seccomp fallback when the kernel ABI lacks network support (< V4). This is the default'
...
complete -c nono -n "__fish_nono_using_subcommand shell" -l sandbox-policy -d 'Linux sandbox enforcement mechanism [auto|landlock|external] (default: auto)' -r -f -a "auto\t'Landlock plus a static seccomp baseline for restricted networking, with automatic seccomp fallback when the kernel ABI lacks network support (< V4). This is the default'
landlock\t'Landlock only. Returns an error at startup if the kernel cannot satisfy network restrictions via Landlock alone'
external\t'TCP network egress enforcement is managed externally (iptables, cgroups, systemd, etc.). nono still installs filesystem/process sandboxing and skips only its own TCP network lockdown'"
...
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -l theme -d 'Color theme for output (mocha, latte, frappe, macchiato, tokyo-night, minimal)' -r
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -l log-file -d 'Write logs to a file instead of stderr' -r -F
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -s h -l help -d 'Print help'
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -s s -l silent -d 'Silent mode - suppress all nono output (banner, summary, status)'
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -f -a "list" -d 'List all sandboxed sessions'
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -f -a "show" -d 'Show audit details for a session'
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -f -a "verify" -d 'Verify audit integrity by recomputing hashes from the event log'
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -f -a "cleanup" -d 'Remove old audit sessions'
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -f -a "sync" -d 'Deliver queued final audit sessions to the enrolled platform'
complete -c nono -n "__fish_nono_using_subcommand audit; and not __fish_seen_subcommand_from list show verify cleanup sync status" -f -a "status" -d 'Show audit delivery queue status'
...
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from list" -l no-tools -d 'Hide the per-session mediated tool summary'
...
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from sync" -l theme -d 'Color theme for output (mocha, latte, frappe, macchiato, tokyo-night, minimal)' -r
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from sync" -l log-file -d 'Write logs to a file instead of stderr' -r -F
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from sync" -l json -d 'Print delivery results as JSON'
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from sync" -s h -l help -d 'Print help'
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from sync" -s s -l silent -d 'Silent mode - suppress all nono output (banner, summary, status)'
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from status" -l theme -d 'Color theme for output (mocha, latte, frappe, macchiato, tokyo-night, minimal)' -r
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from status" -l log-file -d 'Write logs to a file instead of stderr' -r -F
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from status" -l json -d 'Print status as JSON'
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from status" -s h -l help -d 'Print help'
complete -c nono -n "__fish_nono_using_subcommand audit; and __fish_seen_subcommand_from status" -s s -l silent -d 'Silent mode - suppress all nono output (banner, summary, status)'
complete -c nono -n "__fish_nono_using_subcommand platform; and not __fish_seen_subcommand_from enroll status unenroll" -l theme -d 'Color theme for output (mocha, latte, frappe, macchiato, tokyo-night, minimal)' -r
complete -c nono -n "__fish_nono_using_subcommand platform; and not __fish_seen_subcommand_from enroll status unenroll" -l log-file -d 'Write logs to a file instead of stderr' -r -F
complete -c nono -n "__fish_nono_using_subcommand platform; and not __fish_seen_subcommand_from enroll status unenroll" -s h -l help -d 'Print help'
complete -c nono -n "__fish_nono_using_subcommand platform; and not __fish_seen_subcommand_from enroll status unenroll" -s s -l silent -d 'Silent mode - suppress all nono output (banner, summary, status)'
complete -c nono -n "__fish_nono_using_subcommand platform; and not __fish_seen_subcommand_from enroll status unenroll" -f -a "enroll" -d 'Exchange a one-time token for an audit-only enrolled identity'
complete -c nono -n "__fish_nono_using_subcommand platform; and not __fish_seen_subcommand_from enroll status unenroll" -f -a "status" -d 'Show the locally enrolled platform identity'
complete -c nono -n "__fish_nono_using_subcommand platform; and not __fish_seen_subcommand_from enroll status unenroll" -f -a "unenroll" -d 'Remove the local platform enrollment'
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from enroll" -l url -d 'Platform origin, for example https://nono.example.com' -r
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from enroll" -l token -d 'Short-lived, single-use enrollment token' -r
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from enroll" -l name -d 'Operator-facing label for this device or workload' -r
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from enroll" -l keyref -d 'Private key location (keystore:// name or absolute file:// URI)' -r
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from enroll" -l theme -d 'Color theme for output (mocha, latte, frappe, macchiato, tokyo-night, minimal)' -r
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from enroll" -l log-file -d 'Write logs to a file instead of stderr' -r -F
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from enroll" -l workload -d 'Enroll as a durable workload instead of a developer device'
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from enroll" -s h -l help -d 'Print help'
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from enroll" -s s -l silent -d 'Silent mode - suppress all nono output (banner, summary, status)'
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from status" -l theme -d 'Color theme for output (mocha, latte, frappe, macchiato, tokyo-night, minimal)' -r
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from status" -l log-file -d 'Write logs to a file instead of stderr' -r -F
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from status" -l json -d 'Print status as JSON'
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from status" -s h -l help -d 'Print help'
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from status" -s s -l silent -d 'Silent mode - suppress all nono output (banner, summary, status)'
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from unenroll" -l theme -d 'Color theme for output (mocha, latte, frappe, macchiato, tokyo-night, minimal)' -r
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from unenroll" -l log-file -d 'Write logs to a file instead of stderr' -r -F
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from unenroll" -l delete-key -d 'Also delete the local signing key (the next enrollment mints a new one)'
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from unenroll" -s h -l help -d 'Print help'
complete -c nono -n "__fish_nono_using_subcommand platform; and __fish_seen_subcommand_from unenroll" -s s -l silent -d 'Silent mode - suppress all nono output (banner, summary, status)'
...
complete -c nono -n "__fish_nono_using_subcommand ps" -l console -d 'nono-console origin override (valid only with --remote)' -r
complete -c nono -n "__fish_nono_using_subcommand ps" -l token-file -d 'Explicit console token-file override (valid only with --remote)' -r -F
...
complete -c nono -n "__fish_nono_using_subcommand ps" -l remote -d 'List sessions hosted by the enrolled tenant\'s nono-console'
...
complete -c nono -n "__fish_nono_using_subcommand attach" -l bridge-status -d 'Emit the private nono-console attach-helper readiness protocol'
...
complete -c nono -n "__fish_nono_using_subcommand connect" -l console -d 'nono-console origin; defaults to signed discovery from device enrollment' -r
complete -c nono -n "__fish_nono_using_subcommand connect" -l token-file -d 'Explicit token-file override; normally browser authorization is automatic' -r -F
complete -c nono -n "__fish_nono_using_subcommand connect" -l theme -d 'Color theme for output (mocha, latte, frappe, macchiato, tokyo-night, minimal)' -r
complete -c nono -n "__fish_nono_using_subcommand connect" -l log-file -d 'Write logs to a file instead of stderr' -r -F
complete -c nono -n "__fish_nono_using_subcommand connect" -l read-only -d 'Spectate without sending terminal input (reserved until console fan-out lands)'
complete -c nono -n "__fish_nono_using_subcommand connect" -s s -l silent -d 'Silent mode - suppress all nono output (banner, summary, status)'
complete -c nono -n "__fish_nono_using_subcommand connect" -s h -l help -d 'Print help'
...
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "setup" -d 'Set up nono on this system'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "run" -d 'Run a command inside the sandbox'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "shell" -d 'Start an interactive shell inside the sandbox'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "wrap" -d 'Apply sandbox and exec into command (nono disappears). For scripts, piping, and embedding where no parent process is wanted'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "why" -d 'Check why filesystem, network, scope, or command access would be allowed or denied'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "proxy" -d 'Run the network filtering / credential proxy as a standalone server'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "rollback" -d 'Manage rollback sessions (browse, restore, cleanup)'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "audit" -d 'View audit trail of sandboxed commands'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "platform" -d 'Enroll with and inspect an audit control plane'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "trust" -d 'Manage file trust and attestation'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "ps" -d 'List local or remote sandboxed sessions'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "stop" -d 'Stop a running sandboxed session'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "detach" -d 'Detach from a running sandboxed session and return to the shell'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "attach" -d 'Attach to a detached or running session from another terminal'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "connect" -d 'Connect this terminal to a session hosted by nono-console'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "logs" -d 'View event log for a session'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "inspect" -d 'Show detailed information about a session'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "prune" -d 'Clean up old session files'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "session" -d 'Manage runtime session storage'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "policy" -d '[deprecated] Use \'nono profile\' instead'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "profile" -d 'Create, inspect, and compare nono profiles'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "pull" -d 'Install a signed nono pack from the registry'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "remove" -d 'Remove an installed nono pack'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "update" -d 'Update installed nono packs'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "search" -d 'Search the registry for nono packs'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "list" -d 'List installed nono packs'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "pin" -d 'Pin an installed pack to its current version, excluding it from updates'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "unpin" -d 'Unpin a pack so it is included in updates again'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "outdated" -d 'Show which installed packs have newer versions available'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "open-url-helper" -d 'Internal: open a URL via supervisor IPC'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "pack-update-hint-helper" -d 'Internal: refresh cached pack update hints out of process'
complete -c nono -n "__fish_nono_using_subcommand help; and not __fish_seen_subcommand_from setup run shell wrap why proxy rollback audit platform trust ps stop detach attach connect logs inspect prune session policy profile pull remove update search list pin unpin outdated completion open-url-helper pack-update-hint-helper help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c nono -n "__fish_nono_using_subcommand help; and __fish_seen_subcommand_from audit" -f -a "sync" -d 'Deliver queued final audit sessions to the enrolled platform'
complete -c nono -n "__fish_nono_using_subcommand help; and __fish_seen_subcommand_from audit" -f -a "status" -d 'Show audit delivery queue status'
complete -c nono -n "__fish_nono_using_subcommand help; and __fish_seen_subcommand_from platform" -f -a "enroll" -d 'Exchange a one-time token for an audit-only enrolled identity'
complete -c nono -n "__fish_nono_using_subcommand help; and __fish_seen_subcommand_from platform" -f -a "status" -d 'Show the locally enrolled platform identity'
complete -c nono -n "__fish_nono_using_subcommand help; and __fish_seen_subcommand_from platform" -f -a "unenroll" -d 'Remove the local platform enrollment'

# mise completes terraform from the packslip of whichever version is active.
# @generated by usage's installer for `mise completion fish --tool terraform --install`
...
function __mise_load_terraform
    ...
    ' -- 'terraform' $__mise_line
end
complete -c 'terraform' -f -a '(__mise_load_terraform)'

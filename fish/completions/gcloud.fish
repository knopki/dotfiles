# mise completes gcloud from the packslip of whichever version is active.
# @generated by usage's installer for `mise completion fish --tool gcloud --install`
...
complete -c 'gcloud' -f -a '(__mise_load_gcloud)'
